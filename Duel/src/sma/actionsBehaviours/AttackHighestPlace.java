...
public class AttackHighestPlace extends TickerBehaviour{
	...
	public AttackHighestPlace(Agent a, long period, String enemy) {
		super(a, period);
		this.enemy = enemy;
	...
	public static void askForFirePermission() {
		String query = "toOpenFire(" + PrologHighestPlaceBehavior.sit.enemyInSight + ","
				+ PrologHighestPlaceBehavior.sit.impactProba + ")";
