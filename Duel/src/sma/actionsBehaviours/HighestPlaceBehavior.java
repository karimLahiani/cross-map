...
public class HighestPlaceBehavior extends TickerBehaviour {
	...
	public HighestPlaceBehavior(Agent a, long period) {
		super(a, period);
	...
	void addInterestPoint() {
		if (targetType == Type.Offensive) {
			...
			System.out.println("Player 1 found an offensive point");
		} else {
			agent.defPoints.add(new InterestPoint(Type.Defensive, agent));
			System.out.println("Player 1 found a defensive point");
		}
	}
